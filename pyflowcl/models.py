...
class Customer:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> Customer:  # noqa: F821
...
class CustomerRequest:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CustomerRequest:  # noqa: F821
        apiKey = d.get("apiKey")
        customerId = d.get("customerId")
        email = d.get("email")
        externalId = d.get("externalId")
...
class CustomerList:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CustomerList:  # noqa: F821
        total = d.get("total")
        hasMore = d.get("hasMore")
        data = d.get("data")
...
class CustomerRegisterResponse:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CustomerRegisterResponse:  # noqa: F821
        url = d.get("url")
        token = d.get("token")
...
class CustomerRegisterStatusResponse:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CustomerRegisterStatusResponse:  # noqa: F821
        creditCardType = d.get("creditCardType")
        customerId = d.get("customerId")
        last4CardDigits = d.get("last4CardDigits")
        status = d.get("status")
...
class CustomerChargeRequest:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CustomerChargeRequest:  # noqa: F821
        amount = d.get("amount")
        apiKey = d.get("apiKey")
        commerceOrder = d.get("commerceOrder")
        currency = d.get("currency")
...
class CollectResponse:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CollectResponse:  # noqa: F821
        type = d.get("type")
        commerce_order = d.get("commerceOrder")
        flow_order = d.get("flowOrder")
        url = d.get("url")
...
class CollectRequest:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CollectRequest:  # noqa: F821
        amount = d.get("amount")
        apiKey = d.get("apiKey")
...
class CollectObject:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> CollectObject:  # noqa: F821
...
class BatchCollectRequest:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> BatchCollectRequest:  # noqa: F821
        apiKey = d.get("apiKey")
...
class BatchCollectRejectedRow:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> BatchCollectRejectedRow:  # noqa: F821
        customerId = d.get("customerId")
        commerceOrder = d.get("commerceOrder")
...
class BatchCollectResponse:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> BatchCollectResponse:  # noqa: F821
        token = d.get("token")
